...
namespace decomposer {
    ...
    InverseNSFSizeJoinEstimationFitnessFunction::InverseNSFSizeJoinEstimationFitnessFunction(void) {
    }
    ...
    htd::FitnessEvaluation* InverseNSFSizeJoinEstimationFitnessFunction::fitness(const htd::IMultiHypergraph& graph,
    ...
    double InverseNSFSizeJoinEstimationFitnessFunction::removedCount(const htd::ITreeDecomposition& decomposition, htd::vertex_t node, double& fitness) const {
        double value = 0.0;
    ...
    InverseNSFSizeJoinEstimationFitnessFunction * InverseNSFSizeJoinEstimationFitnessFunction::clone(void) const {
        return new InverseNSFSizeJoinEstimationFitnessFunction();
    }
}