...
namespace decomposer {
    ...
    NSFSizeEstimationFitnessFunction::NSFSizeEstimationFitnessFunction(void) {
    }

    NSFSizeEstimationFitnessFunction::~NSFSizeEstimationFitnessFunction() {
    }

    htd::FitnessEvaluation* NSFSizeEstimationFitnessFunction::fitness(const htd::IMultiHypergraph& graph,
    ...
    double NSFSizeEstimationFitnessFunction::removedCount(const htd::ITreeDecomposition& decomposition, htd::vertex_t node, double& fitness) const {
        double value = 0.0;
    ...
    NSFSizeEstimationFitnessFunction * NSFSizeEstimationFitnessFunction::clone(void) const {
        return new NSFSizeEstimationFitnessFunction();
    }
}