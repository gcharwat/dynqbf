...
#include "LevelInverseOrdering.h"
#include "../Application.h"

namespace ordering {

    LevelInverseOrdering::LevelInverseOrdering(Application& app, bool newDefault)
    : Ordering(app, "level-inverse", "ordering based on level (depth) in quantifier sequence (inverse)", newDefault) {
    }

    std::vector<int> LevelInverseOrdering::computeVertexOrder(const HTDHypergraphPtr& instance, const HTDDecompositionPtr& decomposition) const {
