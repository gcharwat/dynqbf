...
namespace ordering {
    ...
    class MaxClauseOrdering : public Ordering {
    public:
        MaxClauseOrdering(Application& app, bool newDefault = false);
    ...
    private:
        ...
        int costsNewVertex(const std::vector<htd::vertex_t>& ordering, const unsigned int newVertexPosition, const htd::vertex_t newVertex) const;
